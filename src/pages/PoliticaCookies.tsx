...
const PoliticaCookies: React.FC = () => {
  return (
    <div className="bg-white">
      ...
      <section className="bg-slate-900 text-white py-16 lg:py-20">
        <div className="max-w-5xl mx-auto px-4 sm:px-6 lg:px-8 text-center">
          ...
          <p className="text-lg md:text-xl text-slate-200 mb-6">
            Información sobre el uso de cookies en CantabriaStorage y cómo
            puedes gestionarlas.
          </p>

          {/* Card resumen cookies */}
          <div className="mt-6 bg-gradient-to-br from-slate-800 to-slate-700 border border-slate-700 p-4 rounded-2xl max-w-2xl mx-auto shadow-lg">
            <div className="flex flex-col sm:flex-row gap-4 justify-center text-sm text-slate-200">
              <div className="flex items-center gap-2">
                <Cookie className="text-brand-400" size={18} />
                Uso responsable de cookies
              </div>

              <div className="flex items-center gap-2">
                <Settings2 className="text-brand-400" size={18} />
                Puedes configurarlas en todo momento
              </div>
      ...
      {/* CONTENIDO POLÍTICA COOKIES */}
      <section className="max-w-4xl mx-auto py-12 px-6 text-slate-800 leading-relaxed">
        <p className="mb-4">
